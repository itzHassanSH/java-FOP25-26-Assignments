...
public abstract class RandomList<T> extends AbstractSelfOrganizingList<T> implements SelfOrganizingList<T> {
    ...
    protected void swapRandom(ListItem<T> element1, ListItem<T> element2) {
        ListItem<T> target1 = element1.next;
        ListItem<T> target2 = element2.next;
        ListItem<T> target1Next = target1.next;
        ...
        element2.next = target1;

        target1.next = target2.next;
        target2.next = target1Next;
