...
public record UserAccount(
    ...
    public Set<Video> videos() {
        // TODO: H12.5.1
        return ownedChannels.stream().flatMap(c -> c.videos().stream()).collect(Collectors.toSet());
    }
    ...
    public Set<Video> subscribedVideos() {
        // TODO: H12.5.1
        return subscribedChannels.stream().flatMap(c -> c.videos().stream()).collect(Collectors.toSet());
    }
    ...
    public Set<Video> getSubscribedVideosByUploader(String uploaderName) {
        // TODO: H12.5.2
        return subscribedChannels.stream().flatMap(c -> c.videos().stream()).filter(v -> v.uploader().displayName().equals(uploaderName)).collect(Collectors.toSet());
    }
}
