...
public record JoinedDeparture(int tripId, String trainLine, String destination, LocalTime scheduledTime, LocalTime actualTime, Duration delay) {
    ...
    public List<String> serialize() {
        // TODO: H13.2.4
        String delay = DepartureTimes.delayToString(delay());
        String scheduledDeparture = DepartureTimes.timeToString(scheduledTime());
        String actualDeparture = DepartureTimes.timeToString(actualTime());
        return List.of(String.valueOf(this.tripId()), this.trainLine(), this.destination(), scheduledDeparture, actualDeparture, delay);
    }
}
